...
equal=1
tree=ParserFile("国家大剧院.txt","Foo先生")#经由parser获得的语法树
tree_stan=Tree()#标准语法树

#开始储存正确语法树
stepnames={"welcome","showProc","purchaseProc","refundProc","complainProc","silenceProc","defaultProc","goodbye"}
...
tree_stan.stepTable["welcome"].output=['Foo先生','欢迎您致电国家大剧院，请问有什么可以帮您？请说：上映剧目、订票、退票、投诉']
tree_stan.stepTable["welcome"].branchTable={'上映剧目':'showProc','订票':'purchaseProc','退票':'refundProc','投诉':'complainProc'}
...
tree_stan.stepTable["showProc"].output=['正在上演的剧目是舞剧《冼星海》，请问您是否要进行购票?请说：是、否']
tree_stan.stepTable["showProc"].branchTable={'是':'purchaseProc','否':'goodbye'}
tree_stan.stepTable["showProc"].Silence='silenceProc'
tree_stan.stepTable["showProc"].Default='defaultProc'
tree_stan.stepTable["showProc"].isEnd=0
tree_stan.stepTable["showProc"].isDeal=0
...
tree_stan.stepTable["refundProc"].output=['您的订票已经取消。']
tree_stan.stepTable["refundProc"].branchTable={}
tree_stan.stepTable["refundProc"].Silence='silenceProc'
tree_stan.stepTable["refundProc"].Default='defaultProc'
tree_stan.stepTable["refundProc"].isEnd=1
tree_stan.stepTable["refundProc"].isDeal=2
...
tree_stan.stepTable["silenceProc"].branchTable={'上映剧目':'showProc','订票':'purchaseProc','退票':'refundProc','投诉':'complainProc'}
...
tree_stan.stepTable["defaultProc"].output=['对不起我没有理解，您能换一种方式表达吗？请说：上映剧目、订票、退票、投诉、退出']
tree_stan.stepTable["defaultProc"].branchTable={'上映剧目':'showProc','订票':'purchaseProc','退票':'refundProc','投诉':'complainProc','退出':'goodbye'}
